...
student P_Open   o = elem o [P_Assignment, P_Solution, P_Course, P_PlainPage]
...
professor P_Open   o = elem o [P_Assignment, P_Solution, P_Statistics, P_Course, P_PlainPage, P_Professor]
professor P_Create o = elem o [P_Assignment]
professor P_Modify o = elem o [P_Assignment, P_Password]
professor P_Delete o = elem o [P_Assignment]

-- * Course Admin

courseAdmin P_Open   o = elem o
  [ P_Assignment, P_Solution, P_Statistics, P_Course, P_CourseAdmin, P_PlainPage, P_User ]
courseAdmin P_Create o = elem o [P_Assignment, P_CourseAdmin, P_Professor ]
...
admin P_Open   o = elem o [P_Assignment, P_Solution, P_Statistics, P_Course, P_CourseAdmin, P_Professor, P_AdminPage, P_PlainPage]
