...
linkText = P.pageCata
  ...
  (Msg_LinkText_CourseAdministration "Course administration")
  ...
  (Msg_LinkText_NewGroupAssignment "New Group Assignment")
  (Msg_LinkText_NewCourseAssignment "New Course Assignment")
  ...
  (Msg_LinkText_NewTestScript "New Test Script")
