...
type GETContentHandler  = HandlerError App App IHtml
type POSTContentHandler = HandlerError App App UserAction
type ViewPOSTContentHandler = HandlerError App App IHtml
...
newtype UserViewHandler = UserViewHandler { unUserViewHandler :: HandlerError App App IHtml }
...
data ViewModifyHandler = ViewModifyHandler (HandlerError App App IHtml) (HandlerError App App UserAction)
...
newtype DataHandler = DataHandler { unDataHandler :: HandlerError App App () }
