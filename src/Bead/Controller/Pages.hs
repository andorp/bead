...
pageTransition s = nub $ p s ++ [s, Error, Logout] where
  ...
  p CourseAdmin      = [Home, Profile, CreateGroup, AssignGroupAdmin]
  p EvaluationTable  = [Home, Profile, Evaluation, ModifyEvaluation]
  p Evaluation       = [Home, Profile, EvaluationTable]
  p Submission       = [Home, Profile, SubmissionList]
  p SubmissionList   = [Home, Profile, SubmissionDetails]
  p SubmissionDetails = [Home, Profile, SubmissionList]
  p Administration   = [Home, Profile, CreateCourse, UserDetails, AssignCourseAdmin]
  p Profile          = [Home, ChangePassword]
  p UserSubmissions  = [Home, Profile, ModifyEvaluation, Evaluation]
  p ModifyEvaluation = [Home, Profile, EvaluationTable]
  p UserDetails      = [Administration]
  p GroupRegistration = [Home, Profile]
  p NewGroupAssignment = [Home, Profile, NewGroupAssignment]
  p NewCourseAssignment = [Home, Profile, NewCourseAssignment]
  p ModifyAssignment    = [Home, Profile]
  ...
  p SetUserPassword   = [Home, Profile]
