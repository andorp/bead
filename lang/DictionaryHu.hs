...
dict = DictionaryFile {
  ...
  entries =
    ...
    , msg_NewAssignment_FftEval <| "Szabadformátum szöveges"
    ...
    , msg_Evaluation_FreeForm_Information <| "Figyelmeztetés: a feladat értékelése a fent megadott szöveg lesz. Ezért ajánlott %d hosszúságnál rövidebbnek lennie, különben helyettesítő szöveg jelenik meg."
    ...
    , msg_LinkText_NewGroupAssessment <| "Új csoportszintű dolgozat eredmények"
    , msg_LinkText_NewCourseAssessment <| "Új tárgyszintű dolgozat eredmények"
    , msg_LinkText_GroupAssessmentPreview <| "Új csoportszintű dolgozat eredmények"
    , msg_LinkText_CourseAssessmentPreview <| "Új tárgyszintű dolgozat eredményeks"
    , msg_LinkText_ViewAssessment <| "Dolgozat eredmények megtekintése"
